...
class GridDicodingEventAdapter(private val onClick: (Int?) -> Unit) :
    RecyclerView.Adapter<GridDicodingEventAdapter.DicodingEventResponseViewHolder>() {
    ...
    class DicodingEventResponseViewHolder(
        ...
        fun bind(item: ListEventsItem) {
            ...
            eventBeginTime.text = DateHelper.format(item.beginTime)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DicodingEventResponseViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.grid_dicoding_event, parent, false)
